...
def prepare_aishell3(
    ...
    # merge_name=None,
    merge_train_lst=[],
    merge_train_name=None,
    merge_valid_lst=[],
    merge_valid_name=None,
    ...
    if merge_train_lst and merge_train_name is not None:
        merge_train_files = ["train_" + split_train + ".csv" for split_train in merge_train_lst]
        merge_csvs(
            data_folder=save_folder, csv_lst=merge_train_files, merged_csv=merge_train_name
        )
        
    # Merging valid.csv file if needed
    if merge_valid_lst and merge_valid_name is not None:
        merge_valid_files = ["test_" + split_valid + ".csv" for split_valid in merge_valid_lst]
        merge_csvs(
            data_folder=save_folder, csv_lst=merge_valid_files, merged_csv=merge_valid_name
        )
