...
from model import FusionModule, read_image
...
class ASR(sb.Brain):
    def __init__(self, modules=None, hparams=None, run_opts=None, opt_class=None, checkpointer=None):
        ...
        self.fusion_module = FusionModule()  # 初始化 FusionModule
    ...
    def compute_forward(self, batch, stage):
        ...
        # visual_input = batch.visual_features  # 提取視覺輸入
        ...
        fused_features = self.fusion_module(wavs, visual_input)
...
def dataio_prepare(hparams, tokenizer):
    ...
    @sb.utils.data_pipeline.takes("visual")
    @sb.utils.data_pipeline.provides("visual_features")
    def visual_pipeline(visual):
        visual_features = read_image(visual)
    ...
    sb.dataio.dataset.set_output_keys(
        datasets,
        ["id", "sig", "visual_features", "tokens_list", "tokens_bos", "tokens_eos", "tokens"],
    )
